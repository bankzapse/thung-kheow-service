...
export function iconSvg({ maskable = false } = {}) {
  ...
  <defs>
    ...
    <radialGradient id="gloss" cx="0.5" cy="0.5" r="0.5">
      <stop offset="0" stop-color="#ffffff" stop-opacity="0.42"/><stop offset="0.72" stop-color="#ffffff" stop-opacity="0.24"/><stop offset="0.93" stop-color="#ffffff" stop-opacity="0.13"/><stop offset="1" stop-color="#ffffff" stop-opacity="0"/>
    </radialGradient>
  ...
  <g clip-path="url(#r)">
    <circle cx="150" cy="-140" r="540" fill="url(#gloss)"/>
    <circle cx="150" cy="-140" r="540" fill="none" stroke="#ffffff" stroke-opacity="0.18" stroke-width="4"/>
  </g>

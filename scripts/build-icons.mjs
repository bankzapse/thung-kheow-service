...
export function iconSvg({ maskable = false } = {}) {
  ...
  <defs>
    <linearGradient id="dark" x1="256" y1="240" x2="256" y2="504" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#178c4a"/><stop offset="1" stop-color="#0b4f27"/>
    </linearGradient>
    ...
    <radialGradient id="gloss" cx="96" cy="80" r="300" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ffffff" stop-opacity="0.42"/><stop offset="0.62" stop-color="#ffffff" stop-opacity="0.16"/><stop offset="1" stop-color="#ffffff" stop-opacity="0"/>
    </radialGradient>
  ...
  <rect x="8" y="8" width="496" height="496" rx="${rx}" fill="url(#dark)"/>
  <g clip-path="url(#r)">
    <path d="M8 8 H504 V256 Q256 320 8 256 Z" fill="url(#light)"/>
    <path d="M8 8 H504 V256 Q256 320 8 256" fill="none" stroke="#ffffff" stroke-opacity="0.16" stroke-width="3"/>

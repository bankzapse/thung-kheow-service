...
export function iconSvg({ maskable = false } = {}) {
  ...
  <defs>
    ...
    <radialGradient id="gloss" cx="96" cy="80" r="300" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ffffff" stop-opacity="0.55"/><stop offset="0.62" stop-color="#ffffff" stop-opacity="0.22"/><stop offset="1" stop-color="#ffffff" stop-opacity="0"/>
    </radialGradient>
  ...
  <g clip-path="url(#r)">
    ...
    <circle cx="44" cy="40" r="252" fill="none" stroke="#ffffff" stroke-opacity="0.20" stroke-width="4"/>
  </g>

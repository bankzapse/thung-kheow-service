...
export function defaultFlowConfig(): FlowConfig {
  return {
    ...
    styles: {
      header: { font: "", title: "#ffffff", body: "#d9f4e3", scale: 1 },
      steps: { font: "", title: "#153d29", body: "#5b6b60", scale: 1 },
      materials: { font: "", title: "#153d29", body: "#5b6b60", scale: 1 },
      promo: { font: "", title: "#ffffff", body: "#eafaf0", scale: 1 },
      footer: { font: "", title: "#991b1b", body: "#ffffff", scale: 1 },
    },
...
export function defaultCabinetConfig(): CabinetConfig {
  return {
    ...
    lineId: LINE_OA_ID,
    styles: {
      header: { font: "", title: "#ffffff", body: "#ffffff", scale: 1 },
      steps: { font: "", title: "#ffffff", body: "#ffffff", scale: 1 },
      footer: { font: "", title: "#ffffff", body: "#ffffff", scale: 1 },
    },
    logoUri: "/poster-logo.svg",
    qrUri: "",
  };

...
export interface Database {
  public: {
    Tables: {
      ...
      profiles: {
        Row: { id: string; role: UserRole; name: string; phone: string | null; email: string | null; line_user_id: string | null; line_connected: boolean; base_lat: number | null; base_lng: number | null; status: string; credit: number; partner: boolean; points: number; owner: boolean; permissions: string[]; franchise_id: string | null; address: string | null; province: string | null; district: string | null; subdistrict: string | null; created_at: string; roles: Json | null; payout: Json | null; consent_at: string | null; consent_version: string | null; consent_source: string | null; username: string | null; phone_verified: boolean; deleted_at: string | null };
